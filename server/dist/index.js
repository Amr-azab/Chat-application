...
const app = (0, express_1.default)(); //app
app.use((0, body_parser_1.json)()); //app
app.use((0, cors_1.default)({ origin: "http://localhost:3000", credentials: true })); //app
app.options("*", (0, cors_1.default)()); //app
...
app.use(errorController_1.default); //app
// ###########################################################
// Socket IO server
